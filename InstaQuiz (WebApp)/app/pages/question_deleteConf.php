<?php
    session_start();
    $pageTitle = "Delete Question Confirmation";
...
<body>
    ...
    <div class='container'>
        <div class='container-form'>
            ...
            <form action='../scripts/question_delete.php' method='POST'>
                <input type='hidden' name='qid' value='<?= $qid ?>'>
                <button class='bad-button' type='submit'>I am totally sure that I want to delete this question.</button>
            </form>
